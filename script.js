...
function initZappyAccessibilityToolbar() {
    ...
    try {
        ...
        var pageLang = (htmlEl.getAttribute('lang') || 'de').toLowerCase().split('-')[0];
        ...
        var forceLang = langMap[pageLang] || 'de-DE';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2d66aec0-3b3e-4d33-aa10-6b02d64015d3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2d66aec0-3b3e-4d33-aa10-6b02d64015d3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2d66aec0-3b3e-4d33-aa10-6b02d64015d3';
